...
class EmbeddingLogLinearLanguageModel(LanguageModel, nn.Module):
    ...
    def __init__(self, vocab: Vocab, lexicon_file: Path, l2: float, epochs: int) -> None:
        ...
        # self.dim = self.lexicon.embedding_dim
        # OOL is guaranteed to exist
        ool_idx = self.lexicon.vocab.index('OOL')
        self.ool_embedding = self.lexicon.embeddings[ool_idx]
        # print(f"shape of ool_embedding: {self.ool_embedding.shape}")
        self.epochs = epochs
    ...
    def log_prob_tensor(self, x: Wordtype, y: Wordtype, z: Wordtype) -> TorchScalar:
        ...
        # Check if x, y, z is OOV; if so, convert to OOL to obtain vector
        ...
        # print(f"x, y, z in log_prob_tensor: {x, y, z}")
        ...
        # print(f"Size of vocab: {len(self.vocab)}")  # This should print 30
    ...
    def logits(self, x: Wordtype, y: Wordtype) -> Float[torch.Tensor,"vocab"]:
        ...
        # print(f"shape of x_embed: {x_embed.shape}")
        # print(f"shape of y_embed: {y_embed.shape}")
        ...
        # print(f"shape of logit: {logit.shape}")
